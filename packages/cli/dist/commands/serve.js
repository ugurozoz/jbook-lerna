...
var local_api_1 = require("@jsnote-uurzz/local-api");
var isProduciton = process.env.NODE_ENV === 'production';
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, local_api_1.serve(parseInt(options.port), path_1.default.basename(filename), dir, !isProduciton)];
                case 1:
                    _a.sent();
